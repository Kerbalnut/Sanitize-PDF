...
::https://github.com/Kerbalnut/Batch-Tools-SysAdmin/blob/master/Tools/Debug-TroubleshootBatchFile.bat
...
SET "_BatchPath=%USERPROFILE%\Documents\GitHub\Sanitize-PDF\Sanitize-PDF.bat"
